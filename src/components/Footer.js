    ...
    return (
      ...
      >
        <Nav className="mx-auto">
          <Nav.Link href="https://github.com/sammed-sankonatti" target="_blank">
          ...
          <Nav.Link href="https://www.linkedin.com/in/sammed-sankonatti-bb7492148/" target="_blank">
            <FontAwesomeIcon icon={faLinkedin} /> {smallViewArray[4]}
          </Nav.Link>
          <Nav.Link href="https://www.facebook.com/samsank31" target="_blank">
            <FontAwesomeIcon icon={faFacebookSquare} /> {smallViewArray[5]}
          </Nav.Link>
          <Nav.Link href="https://www.instagram.com/sammed.sankonatti " target="_blank">
